...
def ResNet10_8x(num_classes=10):
    """ ResNet-10 (8x) model definition using BasicBlock. """
    print("Initializing ResNet10_8x")
...
def ResNet56_8x(num_classes=10):
    print("Initializing ResNet56_8x")
    return ResNet(BasicBlock, [9, 9, 9, 3], num_classes)
